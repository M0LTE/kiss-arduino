...
int cur;
// This program will just send a UI frame containing the letter a repeatedly
...
void setup() {
  ...
  String str = "This is my string hello world 1234s zfsdgn zsdlfkjlkszjdf  lskzdfhkjszd"; 
  cur = str.length() + 1; 
  str.toCharArray(serialBuffer, cur);
